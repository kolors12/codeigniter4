        ...
        <div class="container-fluid">
          ...
          <div class="col-12">
             <a href="<?php echo base_url();?>UsersController/Createusers"><button type="button" class="btn btn-primary btn-sm">Add Users</button></a>
              ...
              <input type="text" name="q" class="form-control form-control-lg" placeholder="Search By Frist Name" required/>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="<?php echo base_url();?>UsersController/edit/<?php echo $row['guid'];?>" class="btn btn-primary btn-sm">Edit </a>
                            <a href="<?php echo base_url();?>UsersController/deleteuser/<?php echo $row['guid'];?>" class="btn btn-danger btn-sm" onClick="return delete1();">Delete </a>
                        </td>
