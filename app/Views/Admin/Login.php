        ...
        <div class="auth-box bg-dark border-top border-secondary">
          ...
          <?php  }?>
            ...
            <?php if(session()->getFlashdata('msg')):?>
                ...
                <?php endif;?>
            <form  class="form-horizontal mt-3" id="form" method="post" action="<?php echo base_url(); ?>Login/loginAuth">
              <div class="row pb-4">
                <div class="col-12">
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control form-control-lg" placeholder="Email" name="eamil"  id="eamil" required/>
                  </div>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
              ...
              <div class="row border-top border-secondary">
                <div class="col-12">
                  <div class="form-group">
                    <div class="pt-3">
                    <a href="<?php echo base_url();?>Login/Register"><button class="btn btn-info"  type="button">
                        <i class="mdi mdi-lock fs-4 me-1"></i> Sign Up
                      </button></a>
