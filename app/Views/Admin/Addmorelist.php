     ...
     <?php include("Header.php");?>
      ...
      <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Add More Users</h4>
        ...
        <div class="container-fluid">
          ...
          <div class="col-12">
             <a href="<?php echo base_url();?>AddMoreController/addmoreusers"><button type="button" class="btn btn-primary btn-sm">Add More  Users</button></a>
              <div class="card">
                <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="<?php echo base_url();?>AddMoreController/deleteuser/<?php echo $row['id'];?>" class="btn btn-danger btn-sm" onClick="return delete1();">Delete </a>
                        </td>
